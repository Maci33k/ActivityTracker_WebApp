...
namespace ActivityTrackerAPI.Migrations
{
    ...
    [Migration("20240820092118_add-training-table")]
    partial class addtrainingtable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityTrackerAPI.Models.TrainingActivity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ActivityTrackerAPI.Models.TrainingActivity", b =>
                {
                    b.HasOne("ActivityTrackerAPI.Models.ActivityData", "ActivityData")
                        .WithOne("Training")
                        .HasForeignKey("ActivityTrackerAPI.Models.TrainingActivity", "ActivityDataID");

                    b.HasOne("ActivityTrackerAPI.Models.User", null)
                        .WithMany("Trainings")
                        .HasForeignKey("userID");
